...
read -p "$BLUE Please Enter Your Name:$WHITE " Name

banner() {

     echo "$WHITE    _   ______ ________ ______     __  _______ __________        ___________   ______  __________ "
     echo "$BLUE   / | / / __ <  / ___// ____/    / / / / ___// ____/ __ \      / ____/  _/ | / / __ \/ ____/ __  "
     echo "$WHITE  /  |/ / / / / /\__ \/ __/______/ / / /\__ \/ __/ / /_/ /_____/ /_   / //  |/ / / / / __/ / /_/ /"
     echo "$BLUE / /|  / /_/ / /___/ / /__/_____/ /_/ /___/ / /___/ _, _/_____/ __/ _/ // /|  / /_/ / /___/ _, _/ "
     echo "$WHITE/_/ |_/\____/_//____/_____/     \____//____/_____/_/ |_|     /_/   /___/_/ |_/_____/_____/_/ |_|  "
     echo "$BLUE                                               =============="
     echo "$WHITE                                               |  Welcome   |"
     echo "$BLUE                                               |     $Name   |"
     echo "$WHITE                                               ============== "
